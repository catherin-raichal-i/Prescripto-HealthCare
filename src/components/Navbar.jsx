            ...
            <div className='flex items-center gap-4'>
                {
                    token ? <div className='flex items-center gap-4 cursor-pointer group relative'>
                        ...
                        : <button onClick={() => navigate('/login')} className='bg-purple-600 cursor-pointer text-white px-8 py-3 rounded-full font-light hidden md:block'>Create Account</button>
